package com.itsthwng.twallpaper.ui.component.customView.autofit
 ...
 */
class AutoResizeTextView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = R.attr.textViewStyle) : AppCompatTextView(context, attrs, defStyle) {
